...
public:
    ...
    Entity CreateBox(Scene& scene, vec2 pos, vec2 bounds, float rotation = 0, Entity id = NULL);
    ...
    Entity CreateProjectile(Scene& scene,vec2 pos, float radius, vec2 dir, float force, Entity id = NULL);
    ...
    Entity CreateAngularImpulseEvent(Scene& scene, Entity target, float force, Entity id = NULL);
